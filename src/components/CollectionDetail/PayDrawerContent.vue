          ...
          <div class="simpleInfo">
            ...
            <div class="simpleInfoRt">
              ...
              <div class="price-info">
                <span class="simpleType">category：{{ categoryName }}</span>
                <span class="simpleNum">x1</span>
                <span class="simplePrice">HK${{ price.toFixed(2) }}</span>
              </div>
              <span class="author"
                >by
                {{ productCreatorNickName | ellipsisNickName }} offered</span
              >
            </div>
          </div>
