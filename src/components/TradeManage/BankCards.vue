  ...
  <div>
    <el-row :gutter="20" style="margin-bottom: 0.3rem;">
      <!-- <el-col :xs="24" :sm="12" :md="8" v-for="item in banks" :key="item.id">
        <div class="card flex-box-center">
          <!-- <div class="bankLogo">
             &lt;!&ndash;
            <img
              src="../../assets/images/bank/zhongguogongshangyinhang@2x.png"
              alt=""
            />
            &ndash;&gt;  
          </div>  
          <div class="bankInfo">
            ...
            <span class="cardNum">
              {{ item.accountNumber | ellipsisBankCard }}
            </span>
          </div>
        </div>
      </el-col> -->
    ...
    <MTipModal
      ...
      title="Tips"
      content="Please note that you cannot adding your bank card because you have not verified your real name yet。"
      cancelTxt="cancel"
      confirmTxt="confirm"
...
<script>
import addBankcard from '@/pcviews/AddCertificationBank'
import addMBankcard from '@/views/AddCertificationBank'
              ...
              if (result.data !== null) {
                if (result.data.status !== 1) {
                  if (clientWidth < 800) {
                    ...
                    this.$confirm(
                      'Please note that you cannot adding your bank card because you have not verified your real name yet。',
                      'Tips',
                      {
